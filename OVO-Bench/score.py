...
if args.model in ["Dispider", "GPT", "Gemini", "InternVL2", "QWen2VL_7B", "QWen2VL_72B", "QWen2VL_7B_", "QWen2VL_72B_", "LongVU", "LLaVA_OneVision", "LLaVA_Video", "videollm_online", "FlashVStream", "MiniCPM_o"]:
